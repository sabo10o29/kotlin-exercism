...
class BinarySearchTest {
    ...
    @Test
    fun `finds value in array of even length2`() =
            assertEquals(8, BinarySearch.search(listOf(1, 3, 5, 8, 13, 21, 34, 55, 89, 144, 233, 377), 89))

    @Test
    fun `finds value in array of even length3`() {
        val list = listOf(1, 3, 5, 8, 13, 21, 34, 55, 89, 144, 233, 377,455, 566, 777)
        (0 until list.size).forEach {
            assertEquals(it, BinarySearch.search(list, list[it]))
        }
    }
